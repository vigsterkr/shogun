...
private:
	 ...
	 * @return accuracy
	 */
	float64_t evaluate_real(std::shared_ptr<CStructuredLabels > predicted, std::shared_ptr<CStructuredLabels > ground_truth);
	 ...
	 * @return accuracy
	 */
	float64_t evaluate_sequence(std::shared_ptr<CStructuredLabels > predicted, std::shared_ptr<CStructuredLabels > ground_truth);
	 ...
	 * @return accuracy
	 */
	float64_t evaluate_sparse_multilabel(std::shared_ptr<CStructuredLabels > predicted,
