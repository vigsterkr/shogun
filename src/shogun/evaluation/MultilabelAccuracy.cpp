...
float64_t CMultilabelAccuracy::evaluate(std::shared_ptr<CLabels> predicted,
        std::shared_ptr<CLabels> ground_truth)
{
    ...
    auto m_predicted = std::static_pointer_cast<CMultilabelLabels>(predicted);
    auto m_ground_truth = std::static_pointer_cast<CMultilabelLabels>(ground_truth);
