...
CMatchWordStringKernel::CMatchWordStringKernel(
		std::shared_ptr<CStringFeatures<uint16_t>> l, std::shared_ptr<CStringFeatures<uint16_t>> r, int32_t d)
...
bool CMatchWordStringKernel::init(std::shared_ptr<CFeatures> l, std::shared_ptr<CFeatures> r)
{
...
{
	degree=0;
	set_normalizer(std::make_shared<CAvgDiagKernelNormalizer>());
