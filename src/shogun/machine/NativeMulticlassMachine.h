...
class CNativeMulticlassMachine : public CMulticlassMachine
{
	...
	protected:
		...
		virtual bool init_machine_for_train(std::shared_ptr<CFeatures> data) { return true; }

		/** abstract init machines for applying method */
		virtual bool init_machines_for_apply(std::shared_ptr<CFeatures> data) { return true; }

		/** check whether machine is ready */
		virtual bool is_ready() { return true; }

		/** obtain machine from trained one */
		virtual std::shared_ptr<CMachine> get_machine_from_trained(std::shared_ptr<CMachine> machine) const { return NULL; }
		...
		virtual bool is_acceptable_machine(std::shared_ptr<CMachine >machine) { return true; }
