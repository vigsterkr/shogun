...
CMultilabelModel::CMultilabelModel(std::shared_ptr<CFeatures > features, std::shared_ptr<CStructuredLabels > labels)
...
std::shared_ptr<CStructuredLabels > CMultilabelModel::structured_labels_factory(int32_t num_labels)
{
...
float64_t CMultilabelModel::delta_loss(std::shared_ptr<CStructuredData > y1, std::shared_ptr<CStructuredData > y2)
{
...
std::shared_ptr<CResultSet > CMultilabelModel::argmax(SGVector<float64_t> w, int32_t feat_idx,
                                      bool const training)
{
