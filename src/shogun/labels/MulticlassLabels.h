...
class CMulticlassLabels : public CDenseLabels
{
	public:
		 ...
		 */
		CMulticlassLabels(std::shared_ptr<CFile> loader);
		 ...
		 */
		CMulticlassLabels(std::shared_ptr<CBinaryLabels> labels);
		 ...
		 */
		std::shared_ptr<CBinaryLabels> get_binary_for_class(int32_t i);
		...
		*/
		 ...
		 */
		static std::shared_ptr<CMulticlassLabels> obtain_from_generic(std::shared_ptr<CLabels> labels);
