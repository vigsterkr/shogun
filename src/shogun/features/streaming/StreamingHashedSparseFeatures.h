...
public:
	 ...
	 */
	CStreamingHashedSparseFeatures (std::shared_ptr<CStreamingFile> file, bool is_labelled, int32_t size,
	 ...
	 */
	CStreamingHashedSparseFeatures (std::shared_ptr<CSparseFeatures<ST>> dot_features, int32_t d = 512,
