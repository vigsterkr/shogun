...
struct T_ATTRIBUTE
{
	...
	char* attr_name;
	/// attribute object
	std::shared_ptr<CFeatures> attr_obj;
};
...
public:
	 ...
	 */
	std::shared_ptr<CFeatures> get_attribute(char* attr_name);
	 ...
	 */
	void get_attribute_by_index(int idx, const char* &attr_name, std::shared_ptr<CFeatures>& attr_obj);
	 ...
	 */
	bool set_attribute(char* attr_name, std::shared_ptr<CFeatures> attr_obj);
