...
class CLMNNImpl
{
	public:
		 ...
		 */
		static SGMatrix<index_t> find_target_nn(std::shared_ptr<CDenseFeatures<float64_t>> x, std::shared_ptr<CMulticlassLabels> y, int32_t k);
	...
	private:
		...
		static SGMatrix<float64_t> compute_pca_transform(std::shared_ptr<CDenseFeatures<float64_t>> features);
		...
		static ImpostorsSetType find_impostors_exact(
		    ...
		    std::shared_ptr<CMulticlassLabels> y, const SGMatrix<index_t>& target_nn,
		    int32_t k);
		...
		static std::vector<index_t> get_examples_label(std::shared_ptr<CMulticlassLabels> y, float64_t yi);

		/** get the indices of the examples whose label is greater than yi */
		static std::vector<index_t> get_examples_gtlabel(std::shared_ptr<CMulticlassLabels> y, float64_t yi);
		 ...
		 */
		static std::shared_ptr<CEuclideanDistance> setup_distance(std::shared_ptr<CDenseFeatures<float64_t>> x, std::vector<index_t>& a, std::vector<index_t>& b);
		 ...
		 */
		static void check_maximum_k(std::shared_ptr<CLabels> labels, int32_t k);
