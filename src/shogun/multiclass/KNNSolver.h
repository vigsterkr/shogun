...
class CKNNSolver : public CDistanceMachine
{
	public:
		 ...
		 */
		 virtual std::shared_ptr<CMulticlassLabels> classify_objects(std::shared_ptr<CDistance> d, const int32_t num_lab, SGVector<int32_t>& train_lab, SGVector<float64_t>& classes) const = 0;
		 ...
		 * @return the classified labels
		 */
		 virtual SGVector<int32_t> classify_objects_k(std::shared_ptr<CDistance> d, const int32_t num_lab, SGVector<int32_t>& train_lab, SGVector<int32_t>& classes) const = 0;
