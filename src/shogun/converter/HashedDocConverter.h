...
protected:
	 ...
	 */
	int32_t count_distinct_indices(DynamicArray<uint32_t>& hashed_indices);
	 ...
	 */
	SGSparseVector<float64_t> create_hashed_representation(DynamicArray<uint32_t>& hashed_indices);
