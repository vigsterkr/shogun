...
public:
	...
	std::error_condition read(uint64_t offset, size_t n, nonstd::string_view* result, char* scratch) const override
	{
		char* dst = scratch;
		error_condition ec {};
		while (n > 0 && !ec)
		...
		*result = nonstd::string_view(scratch, dst - scratch);
		return ec;
	}
...
public:
	...
	std::error_condition append(nonstd::string_view data) override
	{
	...
	vector<string>* result)
{
	...
	do
	{
		...
		const nonstd::string_view basename = file_name;
