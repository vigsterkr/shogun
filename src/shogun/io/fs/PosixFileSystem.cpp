...
public:
	...
	error_condition read(uint64_t offset, size_t n, nonstd::string_view* result, char* scratch) const override
	{
		char* dst = scratch;
		error_condition ec {};
		while (n > 0 && !ec)
...
public:
	...
	error_condition append(nonstd::string_view data) override
	{
	...
	vector<string>* result) const
{
	...
	{
		nonstd::string_view basename = entry->d_name;
